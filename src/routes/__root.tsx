...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "AS Art Gallery — Concept Art by @sarwarr.rr" },
      { property: "og:description", content: "Monochrome ink portraits and vivid anime pop-art by AS. Based in Hyderabad." },
